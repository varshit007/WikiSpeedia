 ...
 * Written for CS 225 Spring 2011, @author Sean Massung
 */
#pragma once
...
class Graph {
    public:
         ...
         * @return - if exists, return the corresponding edge. else return Edge()
         */
         ...
         * @return - if Vertex exists, true. else return false
         */
        bool vertexExists(Vertex v) const;

        /**
         * Checks if edge exists between two vertices exists.
         * @return - if Edge exists, true. else return false
         */
         ...
         * @param source - one vertex the edge is connected to
         * @param destination - the other vertex the edge is connected to
         * @return - if edge exists, return edge label. else return InvalidLabel
         */
         ...
         * @param source - one vertex the edge is connected to
         * @param destination - the other vertex the edge is connected to
         * @return - if edge exists, return edge weight. else return InvalidWeight
         */
         ...
         * @return - if v exists, return v. else return InvalidVertex;
         */
         ...
         * @param source - one vertex the edge is connected to
         * @param destination - the other vertex the edge is connected to
         * @return - if edge exists, remove it and return removed edge. else return InvalidEdge
         */
         ...
         * @return - if edge exists, set edge weight and return edge with new weight. else return InvalidEdge
         */
